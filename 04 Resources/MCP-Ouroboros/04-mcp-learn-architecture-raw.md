...
For more details about server primitives see [server concepts](/docs/learn/server-concepts).
...
For more details about client primitives see [client concepts](/docs/learn/client-concepts).
