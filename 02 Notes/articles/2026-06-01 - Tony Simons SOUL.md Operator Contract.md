...
- **The EA pattern from the CHIEF + Vellum articles IS the operating-contract pattern from Tony's article.** Different vocabulary, same idea: define the role, define the mission, define the boundaries, define the standards, give permission to act, give permission to push back. The two articles reinforce each other — Article 1 says "here's the vault architecture that makes the EA pattern work" and Tony's article says "here's the contract that makes the EA actually behave like one."
