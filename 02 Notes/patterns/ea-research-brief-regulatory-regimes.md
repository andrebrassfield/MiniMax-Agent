---
description: "The 4 named regulatory regimes ea-research-brief pre-flights before dispatching any research worker. EU AI Act, FDA AI/ML + PCCP, HIPAA Security Rule, State-bar UPL. HALT on any hit + no human-in-the-loop. Moved from skill-local references 2026-06-22 as part of Upgrade 1 aggressive refactor."
source: ~/.mavis/agents/mavis/skills/ea-research-brief/references/regulatory-regimes.md
---
