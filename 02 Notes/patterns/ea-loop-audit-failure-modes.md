---
description: "Failure modes table for ea-loop-audit — the conditions the audit catches + the canonical response per condition. Moved from skill-local references 2026-06-22."
source: ~/.mavis/agents/mavis/skills/ea-loop-audit/references/failure-modes.md
---
