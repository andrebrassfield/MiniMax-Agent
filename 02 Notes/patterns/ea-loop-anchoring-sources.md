---
description: "Primary sources for the 5-stage loop + 6 building blocks vocabulary — Boris Cherny, OpenClaw architecture, Claude Code docs, Karpathy 2025, GEPA, Self-Evolving Agents survey, Alita-G. Cite these, not the @sairahul1 popularization. Moved from skill-local references 2026-06-22 as part of Upgrade 1 skill-scaling-law refactor."
source: ~/.mavis/agents/mavis/skills/ea-loop-thinking/references/anchoring-sources.md
---
