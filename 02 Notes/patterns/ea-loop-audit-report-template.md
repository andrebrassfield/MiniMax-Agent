---
description: "Output report template for ea-loop-audit — standard (7 dim) and deep (17 dim + regulatory) formats, with evidence-pattern guidance. Moved from skill-local references 2026-06-22."
source: ~/.mavis/agents/mavis/skills/ea-loop-audit/references/report-template.md
---
