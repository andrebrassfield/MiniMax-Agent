---
description: "The worker dispatch prompt template ea-research-brief uses — anchoring requirements (quote verbatim, fetch cited sources, end with 'what I don't know,' cross-reference runtime), halt conditions. Moved from skill-local references 2026-06-22."
source: ~/.mavis/agents/mavis/skills/ea-research-brief/references/dispatch-prompt-template.md
---
