# X Thread 3 — The 7 Months That Broke Me (Lived Protocol — Origin Story)

**Status:** ✅ FINAL (locked 2026-06-23)
**Pillar:** Lived Protocol (origin story)
**Publication:** Day 5 (Saturday June 28), 11:00am ET
**CTA:** Substack opt-in (welcome sequence delivers the PDF)
...
**Posting notes:**
- Voice: first-person, raw, "I'm still in this process" anchor in tweet 7
- Compliance: ✅ "My body, not yours" (no "you should"), ✅ no cure/treat/heal, ✅ no sourcing, ✅ the doctor (Dr. Jackson Chism) is referenced by role not name
- Engagement: reply to every comment in first 2 hours, Dre's voice
- Repurpose: convert to a long-form Substack post + LinkedIn carousel