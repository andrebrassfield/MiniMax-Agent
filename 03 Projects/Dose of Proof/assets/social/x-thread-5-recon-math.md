# X Thread 5 — The Recon Math That Almost Killed Me (Reconstitution Utility)

**Status:** ✅ FINAL (locked 2026-06-23)
**Pillar:** Reconstitution Utility (volumetric dilution math)
**Publication:** Day 12 (Saturday July 5), 11:00am ET
**CTA:** Substack opt-in + interest signal for the Dose Calc SaaS
...
**Posting notes:**
- Voice: mechanism-forward, specific math, "I'm still in this process"
- Compliance: ✅ "the math doesn't care" (math is math, not protocol prescription), ✅ Dose Calc explicitly disclaims medical advice, ✅ no sourcing, ✅ "I'm still in this process"
- Engagement: replies should be Dre's voice + math questions
- This thread introduces Dose Calc as a future SaaS — the CTA is the email list, not the app (which doesn't exist yet)
- Repurpose: full Substack post on the recon math + Dose Calc landing page draft + LinkedIn carousel on the math